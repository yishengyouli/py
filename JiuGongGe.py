...
# main.iconbitmap('mr.ico')   #窗口图标(对图标文件路径进行修改)
...
txt_entry.pack()
button1 = tk.Button(
    main, width=10, height=1, text="选择图片", fg="red", bg="yellow", command=select_button
).place(x=30, y=360)
button2 = tk.Button(
    main, width=10, height=1, text="切分图片", fg="red", bg="green", command=cut_button
).place(x=120, y=360)
main.mainloop()  # 执行主循环
